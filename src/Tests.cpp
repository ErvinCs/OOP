...
#include "../headers/Repository/DynamicVector.h"
#include "../headers/Repository/Database.h"
#include "../headers/Controller/Controller.h"
#include "../headers/Util/InsertionSort.h"
#include "../headers/Util/AscAgeComparator.h"
...
void Tests::testDatabase()
{
    ...
    Database<Dog> filtered = db.newBreedAge(name, age);
